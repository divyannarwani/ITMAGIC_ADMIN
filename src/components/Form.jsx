...
function Form() {
  return (
    <>
        <section class="justify-self-start bg-white " >
            <div class="relative left-5 top-2 mx-auto max-w-2xl lg:py-4">
                <h2 class="mb-4 text-xl font-bold text-gray-900 ">ADD NEW LOGO</h2>
                <form action="#">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="sm:col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Logo Name</label>
                    ...
                    <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-gray-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-gray-800">
                        Add product 
                    </button>
                </form>
            </div>
